...
import com.ahyadroid.whatsappclone.util.DATA_USER_PHONE
...
class MainActivity : AppCompatActivity(), FailureCallback{
    ...
    private fun checkNewUserChat(name: String, phone: String) {
                    ...
                    if (it.documents.size > 0){
                        ...
                        AlertDialog.Builder(this).setTitle("User not found")
                            ...
                            .setPositiveButton("OK"){dialog, which ->
                                ...
                                intent.putExtra("sms_body", "Hi i'm using this new cool Whatsapp Clone App. you should install it too so we can chat there")
